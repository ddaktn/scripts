...
begin { 
  ...
  function Format-Output { 
    process { 
      $_ | Select-Object Path, @{Name="Files"; Expression={"{0:N0}" -f $_.Files}}, @{Name="Size"; Expression={"{0:N0}" -f $_.Size}} 
    } 
  } 
...
process { 
  ...
  if ( $Total ) { 
    $output = "" | Select-Object @{Name="Path"; Expression={"<Total>"}}, @{Name="Files"; Expression={$script:totalcount}}, @{Name="Size"; Expression={$script:totalbytes}} 
